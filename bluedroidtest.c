...
gid_t groups[] = { AID_NET_BT, AID_INET, AID_NET_BT_ADMIN,
...
unsigned char bt_enabled = 0;
/* Set to 1 when the Bluedroid stack is discovery */
int bt_discovery_running = 0;
...
static bt_callbacks_t bt_callbacks = {
    ...
    bdt_adapter_properties_callback, /*adapter_properties_cb */
    NULL, /* remote_device_properties_cb */
    bdt_device_found_callback, /* device_found_cb */
    bdt_discovery_state_changed_callback, /* discovery_state_changed_cb */
    NULL, /* pin_request_cb  */
    NULL, /* ssp_request_cb  */
...
const t_cmd console_cmd_list[] =
{
    ...
    /* add here */
    {"start_discovery", bdt_startdiscovery, ":: start discovery device", 0},
    {"cancle_discovery", bdt_canceldiscovery, ":: cancle discovery device", 0},
    {"set_adapterproperty", bdt_set_adapter_property, ":: set adapter property", 0},
    /* last entry */
    {NULL, NULL, "", 0},
};
